class DictWrapper(object):
  """
    DictWrapper allow syntax vDict.key to get value or vDict.key = value to set value:
  ...
  # constructor takes source dict, lowercase and uppercase are modificators to key names
